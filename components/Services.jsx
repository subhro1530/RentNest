...
export const Services = () => {
  const locationList = [
    ...
    },
    {
      ...
      image: "https://www.safehousepg.in/owner/uploads/blog111020221808501.jpg",
      route: "/",
    },
    {
      id: 3,
  ...
  return (
    <section className={` pb-16 ${styles.flexCenter} flex-col relative`}>
      ...
      <div className="flex flex-wrap justify-center w-full  relative-[1]">
        {locationList.map((item) => (
          <div className="flex justify-between flex-col px-3 py-3 w-full rounded-[12px] max-w-[320px] my-2 feedback-card">
